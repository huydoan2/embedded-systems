...
channel MasterHardwareSyncDetect(in signal unsigned bit[1] intr, out signal unsigned bit[1] intr_ack, OSAPI OS_i)
...
channel HardwareBus(OSAPI OS_i)
  implements IMasterHardwareBus, ISlaveHardwareBus
{
  ...
  MasterHardwareSyncDetect  MasterSync0(int0, intr_ack0, OS_i);
  SlaveHardwareSyncGenerate SlaveSync0(int0);

  MasterHardwareSyncDetect  MasterSync1(int1, intr_ack1, OS_i);
