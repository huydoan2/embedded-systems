...
behavior EdgeDraw_WriteOutput(uchar image_buffer[IMAGE_SIZE],  IMasterDriver out_image)
{
    void main(void) {
        out_image.send(image_buffer, IMAGE_SIZE);
    }
};
...
behavior EdgeDraw(i_osuchar7220_receiver in_image, i_osuchar7220_receiver in_mid,  IMasterDriver out_image, OSAPI OS_i)
{
...
behavior Draw(i_osuchar7220_receiver in_image, i_osuchar7220_receiver in_mid,  IMasterDriver out_image, OSAPI OS_i)
{
