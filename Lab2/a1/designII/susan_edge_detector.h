...
#line 43 "/usr/local/packages/sce-20170901/inc/bits/huge_val.h"
typedef union { unsigned char __c[8]; double __d; } __huge_val_t;

#line 41 "/usr/local/packages/sce-20170901/inc/bits/huge_valf.h"
typedef union { unsigned char __c[4]; float __f; } __huge_valf_t;

#line 54 "/usr/local/packages/sce-20170901/inc/bits/pthreadtypes.h"
typedef union {
    char __size[56];
    long int __align; }
    pthread_attr_t;
...
#line 77 "/usr/local/packages/sce-20170901/inc/bits/pthreadtypes.h"
typedef union {

#line 101 "/usr/local/packages/sce-20170901/inc/bits/pthreadtypes.h"
...
#line 116 "/usr/local/packages/sce-20170901/inc/bits/pthreadtypes.h"
typedef union {

#line 133 "/usr/local/packages/sce-20170901/inc/bits/pthreadtypes.h"
...
#line 162 "/usr/local/packages/sce-20170901/inc/bits/pthreadtypes.h"
typedef union {

#line 179 "/usr/local/packages/sce-20170901/inc/bits/pthreadtypes.h"
...
#line 198 "/usr/local/packages/sce-20170901/inc/bits/pthreadtypes.h"
    char __size[56];
    long int __align; }
    pthread_rwlock_t;
...
#line 218 "/usr/local/packages/sce-20170901/inc/bits/pthreadtypes.h"
typedef union {
    char __size[32];
    long int __align; }
    pthread_barrier_t;
...
#line 50 "/usr/local/packages/sce-20170901/inc/bits/pthreadtypes.h"
typedef unsigned long int pthread_t;

#line 65 "/usr/local/packages/sce-20170901/inc/bits/pthreadtypes.h"
typedef struct __pthread_internal_list __pthread_list_t;

#line 151 "/usr/local/packages/sce-20170901/inc/bits/pthreadtypes.h"
...
#line 212 "/usr/local/packages/sce-20170901/inc/bits/pthreadtypes.h"
typedef volatile int pthread_spinlock_t;

#line 57 "/usr/local/packages/sce-20170901/inc/sim/time.sh"
...
#line 3 "c_int7220_queue.sc"
typedef int int7220[7220];

#line 3 "c_uchar7220_queue.sc"
...
#line 609 "susan_edge_detector.h"
...
#line 744 "susan_edge_detector.h"
...
#line 772 "susan_edge_detector.h"
...
#line 786 "susan_edge_detector.h"
...
#line 828 "susan_edge_detector.h"
...
#line 842 "susan_edge_detector.h"
...
#line 870 "susan_edge_detector.h"
...
#line 884 "susan_edge_detector.h"
...
#line 78 "c_double_handshake.sc"
    _specc::event ack;

#line 77 "c_double_handshake.sc"
    _specc::event req;
...
#line 958 "susan_edge_detector.h"
    c_int7220_queue(const unsigned long int (&size));
...
#line 1014 "susan_edge_detector.h"
    c_uchar7220_queue(const unsigned long int (&size));
...
#line 3 "setup_brightness_lut.sc"
    unsigned char (&bp)[516]; int (&thID);
public:

#line 1036 "susan_edge_detector.h"
    SetupBrightnessLutThread(unsigned int _idcnt, unsigned char (&bp)[516], int (&thID));
...
#line 1052 "susan_edge_detector.h"
...
#line 264 "susan_edges.sc"
class SusanEdges_ReadInput : public _specc::behavior
{
private:

#line 264 "susan_edges.sc"
    i_uchar7220_receiver (&in_image); unsigned char (&in_image_buffer)[7220]; int (&r)[7220]; unsigned char (&mid)[7220];
public:

#line 1074 "susan_edge_detector.h"
    SusanEdges_ReadInput(unsigned int _idcnt, i_uchar7220_receiver (&in_image), unsigned char (&in_image_buffer)[7220], int (&r)[7220], unsigned char (&mid)[7220]);
    virtual ~SusanEdges_ReadInput(void);
    void main(void);
private:
};

#line 274 "susan_edges.sc"
...
#line 1092 "susan_edge_detector.h"
...
#line 6 "susan_edges.sc"
class SusanEdgesThread_PartA : public _specc::behavior
{
private:

#line 6 "susan_edges.sc"
    unsigned char (&image_buffer)[7220]; int (&r)[7220]; unsigned char (&bp)[516]; int (&thID);
public:

#line 1108 "susan_edge_detector.h"
    SusanEdgesThread_PartA(unsigned int _idcnt, unsigned char (&image_buffer)[7220], int (&r)[7220], unsigned char (&bp)[516], int (&thID));
...
#line 286 "susan_edges.sc"
    unsigned char (&image_buffer)[7220]; int (&r)[7220]; unsigned char (&bp)[516];
public:

#line 1124 "susan_edge_detector.h"
    SusanEdges_PartA(unsigned int _idcnt, unsigned char (&image_buffer)[7220], int (&r)[7220], unsigned char (&bp)[516]);
...
#line 84 "susan_edges.sc"
    unsigned char (&image_buffer)[7220]; int (&r)[7220]; unsigned char (&mid)[7220]; unsigned char (&bp)[516]; int (&thID);
public:

#line 1146 "susan_edge_detector.h"
    SusanEdgesThread_PartB(unsigned int _idcnt, unsigned char (&image_buffer)[7220], int (&r)[7220], unsigned char (&mid)[7220], unsigned char (&bp)[516], int (&thID));
    virtual ~SusanEdgesThread_PartB(void);
    void main(void);
private:
};

#line 300 "susan_edges.sc"
class SusanEdges_PartB : public _specc::behavior
{
private:

#line 300 "susan_edges.sc"
    unsigned char (&image_buffer)[7220]; int (&r)[7220]; unsigned char (&mid)[7220]; unsigned char (&bp)[516];
public:

#line 1162 "susan_edge_detector.h"
    SusanEdges_PartB(unsigned int _idcnt, unsigned char (&image_buffer)[7220], int (&r)[7220], unsigned char (&mid)[7220], unsigned char (&bp)[516]);
...
#line 314 "susan_edges.sc"
    i_uchar7220_receiver (&in_image); i_int7220_sender (&out_r); i_uchar7220_sender (&out_mid); unsigned char (&bp)[516]; i_uchar7220_sender (&out_image);
public:

#line 1184 "susan_edge_detector.h"
    SusanEdges(unsigned int _idcnt, i_uchar7220_receiver (&in_image), i_int7220_sender (&out_r), i_uchar7220_sender (&out_mid), unsigned char (&bp)[516], i_uchar7220_sender (&out_image));
    virtual ~SusanEdges(void);
    void main(void);
private:

#line 317 "susan_edges.sc"
    unsigned char image_buffer[7220];

    unsigned char mid[7220];

#line 318 "susan_edges.sc"
    int r[7220];
...
#line 8 "detect_edges.sc"
class DetectEdges : public _specc::behavior
{
private:

#line 8 "detect_edges.sc"
    i_uchar7220_receiver (&in_image); i_int7220_sender (&out_r); i_uchar7220_sender (&out_mid); i_uchar7220_sender (&out_image);
public:

#line 1218 "susan_edge_detector.h"
    DetectEdges(unsigned int _idcnt, i_uchar7220_receiver (&in_image), i_int7220_sender (&out_r), i_uchar7220_sender (&out_mid), i_uchar7220_sender (&out_image));
    virtual ~DetectEdges(void);
    void main(void);
private:

#line 11 "detect_edges.sc"
    unsigned char bp[516];
...
#line 1240 "susan_edge_detector.h"
    Edges(unsigned int _idcnt, i_uchar7220_receiver (&in_image), i_int7220_sender (&out_r), i_uchar7220_sender (&out_mid), i_uchar7220_sender (&out_image));
    virtual ~Edges(void);
    void main(void);
private:
...
#line 10 "design.sc"
    i_uchar7220_receiver (&in_image);
    i_int7220_sender (&r);
    i_uchar7220_sender (&mid);
    i_uchar7220_sender (&image_edge_draw);
public:

#line 1262 "susan_edge_detector.h"
    PE1(unsigned int _idcnt, i_uchar7220_receiver (&in_image), i_int7220_sender (&r), i_uchar7220_sender (&mid), i_uchar7220_sender (&image_edge_draw));
    virtual ~PE1(void);
    void main(void);
private:
...
#line 1281 "susan_edge_detector.h"
...
#line 68 "edge_draw.sc"
    unsigned char (&image_buffer)[7220]; i_uchar7220_sender (&out_image);
public:

#line 1297 "susan_edge_detector.h"
    EdgeDraw_WriteOutput(unsigned int _idcnt, unsigned char (&image_buffer)[7220], i_uchar7220_sender (&out_image));
...
#line 5 "edge_draw.sc"
    unsigned char (&image_buffer)[7220]; unsigned char (&mid)[7220]; int (&thID);
public:

#line 1313 "susan_edge_detector.h"
    EdgeDrawThread_PartA(unsigned int _idcnt, unsigned char (&image_buffer)[7220], unsigned char (&mid)[7220], int (&thID));
...
#line 75 "edge_draw.sc"
    unsigned char (&image_buffer)[7220]; unsigned char (&mid)[7220];
public:

#line 1329 "susan_edge_detector.h"
    EdgeDraw_PartA(unsigned int _idcnt, unsigned char (&image_buffer)[7220], unsigned char (&mid)[7220]);
...
#line 1351 "susan_edge_detector.h"
    EdgeDrawThread_PartB(unsigned int _idcnt, unsigned char (&image_buffer)[7220], unsigned char (&mid)[7220], int (&thID));
...
#line 1367 "susan_edge_detector.h"
    EdgeDraw_PartB(unsigned int _idcnt, unsigned char (&image_buffer)[7220], unsigned char (&mid)[7220]);
...
#line 106 "edge_draw.sc"
    i_uchar7220_receiver (&in_image); i_uchar7220_receiver (&in_mid); i_uchar7220_sender (&out_image);
public:

#line 1389 "susan_edge_detector.h"
    EdgeDraw(unsigned int _idcnt, i_uchar7220_receiver (&in_image), i_uchar7220_receiver (&in_mid), i_uchar7220_sender (&out_image));
...
#line 1418 "susan_edge_detector.h"
    Draw(unsigned int _idcnt, i_uchar7220_receiver (&in_image), i_uchar7220_receiver (&in_mid), i_uchar7220_sender (&out_image));
    virtual ~Draw(void);
    void main(void);
private:

#line 134 "edge_draw.sc"
    EdgeDraw edge_draw;
};

#line 204 "susan_thin.sc"
...
#line 1437 "susan_edge_detector.h"
...
#line 1453 "susan_edge_detector.h"
...
#line 6 "susan_thin.sc"
class SusanThinThread : public _specc::behavior
{
private:

#line 6 "susan_thin.sc"
    int (&r)[7220]; unsigned char (&mid)[7220]; int (&thID);
public:

#line 1469 "susan_edge_detector.h"
    SusanThinThread(unsigned int _idcnt, int (&r)[7220], unsigned char (&mid)[7220], int (&thID));
...
#line 1485 "susan_edge_detector.h"
...
#line 236 "susan_thin.sc"
class Thin : public _specc::behavior
{
private:

#line 236 "susan_thin.sc"
    i_int7220_receiver (&in_r); i_uchar7220_receiver (&in_mid); i_uchar7220_sender (&out_mid);
public:

#line 1507 "susan_edge_detector.h"
    Thin(unsigned int _idcnt, i_int7220_receiver (&in_r), i_uchar7220_receiver (&in_mid), i_uchar7220_sender (&out_mid));
    virtual ~Thin(void);
    void main(void);
private:
...
#line 25 "design.sc"
class PE2 : public _specc::behavior
{
private:

#line 25 "design.sc"
    i_int7220_receiver (&r);
    i_uchar7220_receiver (&mid);
    i_uchar7220_receiver (&image_edge_draw);
    i_uchar7220_sender (&out_image);
public:

#line 1541 "susan_edge_detector.h"
    PE2(unsigned int _idcnt, i_int7220_receiver (&r), i_uchar7220_receiver (&mid), i_uchar7220_receiver (&image_edge_draw), i_uchar7220_sender (&out_image));
    virtual ~PE2(void);
    void main(void);
private:
...
#line 1566 "susan_edge_detector.h"
...
#line 1584 "susan_edge_detector.h"
    INPUT(unsigned int _idcnt, i_receive (&start), unsigned char (&image_buffer)[7220], i_uchar7220_sender (&in_image));
    virtual ~INPUT(void);
    void main(void);
private:
...
#line 1603 "susan_edge_detector.h"
...
#line 54 "design.sc"
    i_uchar7220_receiver (&out_image);
    i_sender (&out_image_susan);
public:

#line 1620 "susan_edge_detector.h"
    OUTPUT(unsigned int _idcnt, i_uchar7220_receiver (&out_image), i_sender (&out_image_susan));
    virtual ~OUTPUT(void);
    void main(void);
private:
...
#line 1639 "susan_edge_detector.h"
...
#line 1685 "susan_edge_detector.h"
...
#line 1701 "susan_edge_detector.h"
...
#line 1716 "susan_edge_detector.h"
...
#line 49 "/usr/local/packages/sce-20170901/inc/sim.sh"
extern const int _SPECC_VERSION_MAJOR;
extern const int _SPECC_VERSION_MINOR;

#line 42 "/usr/local/packages/sce-20170901/inc/sim/bit.sh"
extern "C" char *bit2str(unsigned int, char *, ...);

#line 48 "/usr/local/packages/sce-20170901/inc/sim/bit.sh"
...
#line 41 "/usr/local/packages/sce-20170901/inc/sim/longlong.sh"
...
#line 71 "/usr/local/packages/sce-20170901/inc/sim/sim.sh"
extern "C" unsigned long long int thread_id(void);

extern "C" void sim_exit(int);

#line 73 "/usr/local/packages/sce-20170901/inc/sim/time.sh"
...
#line 2738 "susan_edge_detector.h"
