...
#line 597 "main.h"
class PE_node;
class i_packet_tranceiver;

#line 10 "c_packet_queue.sc"
/* note i_packet_tranceiver._SCE_STANDARD_LIB = { "i_tranceiver","packet","packet" }; */

#line 604 "main.h"
class i_packet_sender;

#line 11 "c_packet_queue.sc"
/* note i_packet_sender._SCE_STANDARD_LIB = { "i_sender","packet","packet" }; */

#line 610 "main.h"
class i_packet_receiver;

#line 12 "c_packet_queue.sc"
/* note i_packet_receiver._SCE_STANDARD_LIB = { "i_receiver","packet","packet" }; */

#line 616 "main.h"
class c_packet_queue;

#line 13 "c_packet_queue.sc"
/* note c_packet_queue._SCE_STANDARD_LIB = { "c_queue","packet","packet" }; */
...
#line 633 "main.h"
    virtual ~i_packet_tranceiver(void){};

#line 10 "c_packet_queue.sc"
    virtual void receive(packet *) = 0; virtual void send(packet) = 0;
private:
};
...
#line 661 "main.h"
    virtual ~i_packet_receiver(void){};
...
#line 23 "PE_replay.sc"
class PE_node : public _specc::behavior
{
private:
...
#line 680 "main.h"
    PE_node(unsigned int _idcnt, unsigned int (&id));
    virtual ~PE_node(void);
    ...
    void register_spikes(unsigned int, unsigned int, unsigned int);
    void send_spikes(unsigned int);
    void send_spikes_external(unsigned int, unsigned int, unsigned int);
    void send_spikes_internal(unsigned int, unsigned int, unsigned int);
private:

#line 31 "PE_replay.sc"
    unsigned int max_spikes;

#line 25 "PE_replay.sc"
    unsigned int my_PE_addr;

#line 33 "PE_replay.sc"
    unsigned int spikes_i;

#line 28 "PE_replay.sc"
    unsigned int time;
};

#line 13 "c_packet_queue.sc"
class c_packet_queue : public _specc::channel, public i_packet_sender, public i_packet_receiver, public i_packet_tranceiver
{
private:
...
#line 720 "main.h"
    c_packet_queue(const unsigned long int (&size));
    virtual ~c_packet_queue(void);
    void cleanup(void);
    void receive(packet *);
    void send(packet);
    void setup(void);
...
#line 13 "c_packet_queue.sc"
    packet *buffer; unsigned long int n; unsigned long int p; _specc::event r; _specc::event s; unsigned long int wr; unsigned long int ws;
};
...
#line 1688 "main.h"
float LIF_slope(float, float);
float synaptic_current(unsigned int, float);
